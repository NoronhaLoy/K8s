...
spec:
 ...
 - port: 80
   targetPort: 80
```
> This LoadBalancer Service will be named "nginx-load-balancer". 
> The traffic it receives on port: 80 will be sent to one of the Pods labeled run: app-nginx, on targetPort: 80 of those Pods.
