...
> - In this example, we’re creating an ExternalName Service called "db-prod" that maps to a database running at the domain name "db-prod.example.com". 
> - Once this Service is created, our application can simply use the Service name "db-prod" to access this database running outside the Kubernetes cluster.

_The following is an explanation of the key fields:_
- name: This field specifies the name of the Service object, in this case, "db-prod".
- type: This field specifies the type of Service. In this case, the value is "ExternalName", 
    -  indicating that this Service maps to an external service, not a service inside the Kubernetes cluster.
